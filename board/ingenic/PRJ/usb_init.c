...
void usb_dump_cpm_registers(void)
{
	printf("USB CPM Registers Dump:\n");
	printf("CPM_SRBC     (0x%08x): 0x%08x\n", CPM_SRBC, reg_rd(CPM_SRBC));
	printf("CPM_USBPCR1  (0x%08x): 0x%08x\n", CPM_USBPCR1, reg_rd(CPM_USBPCR1));
	printf("CPM_USBVBFIL (0x%08x): 0x%08x\n", CPM_USBVBFIL, reg_rd(CPM_USBVBFIL));
	printf("CPM_USBRDT   (0x%08x): 0x%08x\n", CPM_USBRDT, reg_rd(CPM_USBRDT));
	printf("CPM_USBPCR   (0x%08x): 0x%08x\n", CPM_USBPCR, reg_rd(CPM_USBPCR));
	printf("CPM_CLKGR0   (0x%08x): 0x%08x\n", CPM_CLKGR0, reg_rd(CPM_CLKGR0));
	printf("CPM_CLKGR1   (0x%08x): 0x%08x\n", CPM_CLKGR1, reg_rd(CPM_CLKGR1));
	printf("CPM_OPCR     (0x%08x): 0x%08x\n", CPM_OPCR, reg_rd(CPM_OPCR));
	printf("CPM_CPAPCR   (0x%08x): 0x%08x\n", CPM_CPAPCR, reg_rd(CPM_CPAPCR));
}
