...
static DmaDesc	_tx_desc[NUM_TX_DESCS] __attribute__((aligned(32)));
static DmaDesc	_rx_desc[NUM_RX_DESCS] __attribute__((aligned(32)));
...
static int jz_init(struct eth_device* dev, bd_t * bd)
{
	...
	printf("MAC PHY Control Register: %x\n", cpm_mphyc);
#elif (CONFIG_NET_GMAC_PHY_MODE == GMAC_PHY_RGMII)
	printf("no found GMAC_PHY_RGMII !!!\n");
