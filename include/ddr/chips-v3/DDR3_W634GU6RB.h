...
#ifndef __DDR3_W634GU6RB_H__
#define __DDR3_W634GU6RB_H__
 ...
 * CL:14, CWL:10 933M ~ 1066M
 *
 * */
#ifndef CONFIG_DDR3_W634GU6RB_MEM_FREQ
#define CONFIG_DDR3_W634GU6RB_MEM_FREQ (CONFIG_SYS_MEM_FREQ * 2)
#endif

#if ((CONFIG_DDR3_W634GU6RB_MEM_FREQ >= 300000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ < 330000000))
#define CONFIG_DDR_CL 5
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ >= 330000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 400000000))
#define CONFIG_DDR_CL 6
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ > 400000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 533000000))
#define CONFIG_DDR_CL 7 // or 8
#define CONFIG_DDR_CWL 6
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ > 533000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 667000000))
#define CONFIG_DDR_CL 9 // or 10
#define CONFIG_DDR_CWL 7
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ > 667000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 800000000))
#define CONFIG_DDR_CL 11
#define CONFIG_DDR_CWL 8
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ > 800000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 933000000))
#define CONFIG_DDR_CL 13
#define CONFIG_DDR_CWL 9
#elif ((CONFIG_DDR3_W634GU6RB_MEM_FREQ > 933000000) && (CONFIG_DDR3_W634GU6RB_MEM_FREQ <= 1066000000))
...
static inline void DDR3_W634GU6RB_INIT(void *data)
{
...
#define DDR3_W634GU6RB                          \
	{                                           \
		.name = "W634GU6RB",                    \
		.id   = DDR_CHIP_ID(TYPE_DDR3),         \
		.type = DDR3,                           \
		.freq = CONFIG_DDR3_W634GU6RB_MEM_FREQ, \
		.size = 512,                            \
		.init = DDR3_W634GU6RB_INIT,            \
	}
