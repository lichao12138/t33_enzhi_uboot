...
#ifndef __DDR2_W9751V6NG_H__
#define __DDR2_W9751V6NG_H__


#ifndef CONFIG_DDR2_W9751V6NG_MEM_FREQ
#define CONFIG_DDR2_W9751V6NG_MEM_FREQ (CONFIG_SYS_MEM_FREQ * 2)
#endif

#if ((CONFIG_DDR2_W9751V6NG_MEM_FREQ >= 133000000) && (CONFIG_DDR2_W9751V6NG_MEM_FREQ < 400000000))
#define CONFIG_DDR_CL 5 // or 6
#elif ((CONFIG_DDR2_W9751V6NG_MEM_FREQ >= 400000000) && (CONFIG_DDR2_W9751V6NG_MEM_FREQ <= 533000000))
#define CONFIG_DDR_CL 7
#elif ((CONFIG_DDR2_W9751V6NG_MEM_FREQ > 533000000) && (CONFIG_DDR2_W9751V6NG_MEM_FREQ <= 667000000))
