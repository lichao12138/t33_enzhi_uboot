...
#define CONFIG_DDR3_W631GU6NG_MEM_FREQ (CONFIG_SYS_MEM_FREQ * 2)
#endif

#if ((CONFIG_DDR3_W631GU6NG_MEM_FREQ >= 300000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ < 330000000))
#define CONFIG_DDR_CL 5
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ >= 330000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 400000000))
#define CONFIG_DDR_CL 6
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ > 400000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 533000000))
#define CONFIG_DDR_CL 7 // or 8
#define CONFIG_DDR_CWL 6
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ > 533000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 667000000))
#define CONFIG_DDR_CL 9 // or 10
#define CONFIG_DDR_CWL 7
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ > 667000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 800000000))
#define CONFIG_DDR_CL 11
#define CONFIG_DDR_CWL 8
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ > 800000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 933000000))
#define CONFIG_DDR_CL 13
#define CONFIG_DDR_CWL 9
#elif ((CONFIG_DDR3_W631GU6NG_MEM_FREQ > 933000000) && (CONFIG_DDR3_W631GU6NG_MEM_FREQ <= 1066000000))
