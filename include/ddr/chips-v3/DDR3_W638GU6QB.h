...
#ifndef __DDR3_W638GU6QB_H__
#define __DDR3_W638GU6QB_H__
 ...
 *
 * */
#ifndef CONFIG_DDR3_W638GU6QB_MEM_FREQ
#define CONFIG_DDR3_W638GU6QB_MEM_FREQ (CONFIG_SYS_MEM_FREQ * 2)
#endif

#if ((CONFIG_DDR3_W638GU6QB_MEM_FREQ >= 300000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ < 330000000))
#define CONFIG_DDR_CL 5
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ >= 330000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 400000000))
#define CONFIG_DDR_CL 6
#define CONFIG_DDR_CWL 5
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ > 400000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 533000000))
#define CONFIG_DDR_CL 7 // or 8
#define CONFIG_DDR_CWL 6
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ > 533000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 667000000))
#define CONFIG_DDR_CL 9 // or 10
#define CONFIG_DDR_CWL 7
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ > 667000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 800000000))
#define CONFIG_DDR_CL 11
#define CONFIG_DDR_CWL 8
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ > 800000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 933000000))
#define CONFIG_DDR_CL 13
#define CONFIG_DDR_CWL 9
#elif ((CONFIG_DDR3_W638GU6QB_MEM_FREQ > 933000000) && (CONFIG_DDR3_W638GU6QB_MEM_FREQ <= 1066000000))
...
static inline void DDR3_W638GU6QB_INIT(void *data)
{
	...
	c->DDR_tRRD         = DDR_SELECT_MAX__tCK_ps(4, 5000);
	...
	c->DDR_tXS          = DDR_SELECT_MAX__tCK_ps(5, 270000);
}

#define DDR3_W638GU6QB                          \
	{                                           \
		.name = "W638GU6QB",                    \
		.id   = DDR_CHIP_ID(TYPE_DDR3),         \
		.type = DDR3,                           \
		.freq = CONFIG_DDR3_W638GU6QB_MEM_FREQ, \
		.size = 1024,                            \
		.init = DDR3_W638GU6QB_INIT,            \
	}
