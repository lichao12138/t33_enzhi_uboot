...
struct desc descriptors[11] = {
    ...
    /*APLL = 600M
     *PLLM  :100(0x64) ; PLLN  :0x1 ; PLLOD1:0x4 ; PLLOD2 :0x1 ;
     *PLL 600000000M : (((0x64) << 20) | ((0x1) << 14) | ((0x4) << 11) | ((0x1) << 8))
     * */
#ifndef CONFIG_FPGA
	{0xb0000010,		0xb0000010,	  0x06406101, 0x8,	0},

    /*
     *MPLL = 1200
     *PLLM  :100(0x64) ; PLLN  :0x1 ; PLLOD1:0x2 ; PLLOD2 :0x1 ;
     *PLL 1200000000M : (((0x64) << 20) | ((0x1) << 14) | ((0x2) << 11) | ((0x1) << 8))
     * */
	{0xb0000014,		0xb0000014,		0x06405101, 0x8,	0},

    /*VPLL = 1000 T33 delet VPLL
     *PLLM  :125(0x7d) ; PLLN  :0x1 ; PLLOD1:0x3 ; PLLOD2 :0x1 ;
     *PLL 1000000000M : (((0x7d) << 20) | ((0x1) << 14) | ((0x3) << 11) | ((0x1) << 8))
     * */
	//{0xb00000e0,		0xb00000e0,		0x07d05901, 0x8,	0},

	/* CPCCR */
	{0xb0000000,		0xb00000d4,		0x557b5510,	0,		0x7},		/* conf DIV */
	{0xb0000000,		0xb00000d4,		0x9a0b5510,	0,		0x7},			/* conf select */
#if (defined(CONFIG_SPL_SFC_SUPPORT) || defined(CONFIG_SPL_SPI_SUPPORT))
	/*if sfc 9:8[0:1]=1/2 or 9:8[1:0]=1/4  SFCCDR[7:0]=>240M(0x4),120M(0x9), 80M(0xe),48M(0x18), 24M(0x31)*/
#if !defined(CONFIG_SFC_ORI_SEL_DF)
	/*后仿SFC频率需要降低，否则读取flash数据异常*/
	//{0xb0000058,		0xb0000058,		0x60000204,	0,		0x10000000},//240M * 1/4 = 60M
	{0xb0000058,		0xb0000058,		0x60000209,	0,		0x10000000},//120M * 1/4 = 30M
#else
	//{0xb0000058,		0xb0000058,		0x60000109,	0,		0x10000000},//120M * 1/2 = 60M
	{0xb0000058,		0xb0000058,		0x60000113,	0,		0x10000000},//60M * 1/2 = 30M
	...
	{0xb00000A4,		0xb00000A4,		0x60000005,	0,		0x10000000},
#endif
#else
	{0xb0011110,		0x0,		0x55555555,	0,		0x0},		/* conf DIV */
#endif
